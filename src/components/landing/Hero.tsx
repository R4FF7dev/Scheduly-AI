      ...
      <div className="container relative z-10 px-4 mx-auto">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left animate-fade-up">
            ...
            <p className="text-xl md:text-2xl text-white/90 mb-8 leading-relaxed">Schedule Smarter, Not Harder</p>

            <p className="text-lg text-white/80 mb-10 max-w-2xl">
              Let AI handle your meeting scheduling through WhatsApp. Get automatic reminders, conflict resolution, and
              meeting summaries - all in your pocket.
            </p>
